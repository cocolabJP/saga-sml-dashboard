...
const TARGET_SENSOR_IDS = [
  ...
  {installed: true,  name: "SAGAアリーナ"}, // 29
  {installed: false, name: ""}, // 30
...
var app = new Vue({
  ...
  methods: {
    ...
    setCurrentTime: function(offset) {
      this.option.start_at = parseInt(Util.getCurrentTime()/1000 - 100 * 10); // 10 min
